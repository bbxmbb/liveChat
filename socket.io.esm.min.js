...
var t = /^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
    ...
    s = function (s) {
        var n = s,
            r = s.indexOf("["),
            i = s.indexOf("]"); - 1 != r && -1 != i && (s = s.substring(0, r) + s.substring(r, i).replace(/:/g, ";") + s.substring(i, s.length));
...
const y = {
    ...
    b = ({
        ...
        return m && e instanceof Blob ? s ? n(e) : v(e, n) : g && (e instanceof ArrayBuffer || (r = e, "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(r) : r && r.buffer instanceof ArrayBuffer)) ? s ? n(e) : v(new Blob([e]), n) : n(d[t] + (e || ""));
        var r
    },
    v = (t, e) => {
...
function et(t) {
    const e = [],
        s = t.data,
        n = t;
    return n.data = st(s, e), n.attachments = e.length, {
        packet: n,
        buffers: e
    }
}
...
function rt(t, e) {
    ...
    if (Array.isArray(t))
        for (let s = 0; s < t.length; s++) t[s] = rt(t[s], e);
...
class at extends u {
    ...
    add(t) {
        let e;
        if ("string" == typeof t) e = this.decodeString(t), e.type === ot.BINARY_EVENT || e.type === ot.BINARY_ACK ? (this.reconstructor = new ht(e), 0 === e.attachments && super.emitReserved("decoded", e)) : super.emitReserved("decoded", e);
        else {
...
export {
    yt as Manager, lt as Socket, gt as connect, gt as
    default, gt as io, it as protocol
};
